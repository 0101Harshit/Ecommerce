...
export default function ProductListScreen() {
  const [{ loading, error, products, pages, loadingCreate, loadingDelete, successDelete }, dispatch] = useReducer(reducer, { loading: false, error: '', products: [], pages: 1, loadingCreate: false, loadingDelete: false })
    ...
    <div>
      <Row>
        ...
        <Col className="col text-end">
          <div>
            <Button type="button" variant="warning" onClick={createHandler}>Create Product</Button>
          </div>
        </Col>
      </Row>
